...
No kernel transition occurs; context switching is performed entirely in user space at a cost typically two or three orders of magnitude lower than a kernel-mediated thread context switch. In modern C++, cooperative multitasking is the premier engine used to orchestrate asynchrony without overhead of preemptive OS threads.

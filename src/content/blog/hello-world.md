...
description: 'A brief introduction to this integrated blogging space.'
pubDate: 'Mar 06 2026'
---
...
- **Styling**: Custom CSS matching the parent React OS
- **Content Flow**: 
  - Markdown files in GitHub 
  - Served via a local JSON API endpoint
  - Fetched dynamically inside the Portfolio's `Blogs.jsx` component

Expect more technical deep-dives here soon.
